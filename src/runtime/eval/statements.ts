import { FunctionDeclaration, IfStatement, Program, Stmt, VarDeclaration, ForStatement, TryCatchStatement, ReturnStatement } from "../../frontend/ast";
...
export function eval_return_statement(declaration: ReturnStatement, env: Environment): RuntimeVal {
    return declaration.value ? evaluate(declaration.value, env) : MK_NULL();
}